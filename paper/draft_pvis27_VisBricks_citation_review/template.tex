...
%% Paper title.
\title{{\system}: Block-Based Authoring of Composite Visualizations}
...
\caption{
Composite visualizations authored with {\system}, spanning Cartesian (a, d, f), polar (b, e),
and geographic (c) coordinates and structures including hierarchical (b, f), network (c, d, e), and statistical charts, illustrating composition across diverse visual forms.
}
...
\usepackage{amssymb}
\usepackage{xcolor}
\newcommand{\mock}[1]{\textcolor{red}{#1}}
