...
.encoding-config__column { display: grid; min-width: 0; align-content: start; gap: 12px; padding: 10px; border: 1px solid rgba(67, 40, 24, 0.1); border-radius: 6px; background: #fbfcfe; }
...
.map-style-control { display: grid; gap: 8px; color: #99582a; font-size: 11px; }
...
.map-style-control__segments button.is-active { background: #fff; color: #432818; box-shadow: 0 1px 2px rgba(67, 40, 24, 0.14); font-weight: 700; }
.appearance-control { display: grid; grid-template-columns: minmax(0, 1fr) minmax(90px, 1.5fr) auto; align-items: center; gap: 10px; color: #99582a; font-size: 11px; }
.appearance-control input[type="color"] { width: 34px; height: 28px; padding: 2px; border: 1px solid rgba(67, 40, 24, 0.16); border-radius: 5px; background: #fff; cursor: pointer; }
.appearance-control input[type="range"] { width: 100%; accent-color: #432818; }
.appearance-control output { min-width: 42px; color: #294a6d; font-size: 10px; text-align: right; }
.geometry-binding { display: grid; grid-template-columns: auto minmax(0, 1fr); align-items: center; gap: 3px 8px; padding: 7px 8px; border-left: 3px solid #99582a; background: #f3faf7; color: #99582a; font-size: 10px; }
...
.encoding-field-control { display: grid; grid-template-columns: 54px minmax(0, 1fr); align-items: center; gap: 8px; color: #99582a; font-size: 11px; }
.encoding-field-control select { min-width: 0; height: 30px; padding: 0 24px 0 7px; border: 1px solid rgba(67, 40, 24, 0.14); border-radius: 5px; background: #fff; color: #263548; font: inherit; }
</style>
